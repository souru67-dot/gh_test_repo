...
**今の状況**: Step 0〜5 完了、**Step 6（TestFlight）進行中**。
アップロードと内部テストは済み、次は**外部テストの申請**
（[IOS_LAUNCH_GUIDE.md](IOS_LAUNCH_GUIDE.md) §8 Step 6-4）です。
...
| [V1_1_BACKLOG.md](V1_1_BACKLOG.md) | バックログ。思いついたら足す → Build 2 か v1.1 に振り分け |
