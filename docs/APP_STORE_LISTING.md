...
| キーワード | `配色,カラーパレット,色見本,レトロ,チェキ,ハーフ,画像加工,加工アプリ,整理,パレット,HEX,韓国風,おしゃれ,Y2K,デイログ,インスタ,組写真,フィルター,現像,日記` | 88 |

**プロモーションテキスト**
```
撮った瞬間、コラージュになるカメラ。カメラロールは色で自動仕分け。
フィルム風・ハーフ・チェキなど12種のテンプレートで、色で集めた写真をそのまま作品に。
```
...
■ グリッド
Instagram風のプロフィール表示で、投稿の並びを事前に確認できます。

■ ColorHunt Pro（買い切り）
・書き出しの透かしを削除
・Pro限定テンプレート7種（ハーフ・チェキ・シームレス・デイログ・パステル・Y2K・マガジン）
・2160pxの高画質書き出し
・今後追加されるPro機能もすべて
...
■ Grid
Preview how your posts will line up, Instagram-style, before you post.
...
| キーワード | `팔레트,색조합,필름카메라,레트로,인생네컷,하프,사진편집,보정앱,정리,HEX,감성,Y2K,다이어리,인스타,꾸미기,색깔,사진정리,빈티지,포토덤프,무드보드` |
...
| サブタイトル | `拍下的瞬间，就成了拼图` |
| キーワード | `配色,调色板,胶片相机,复古,拍立得,半格,图片编辑,修图,整理,HEX,氛围感,Y2K,手帐,ins风,拼贴,拼图,相册整理,滤镜,照片墙,四格,无缝` |
